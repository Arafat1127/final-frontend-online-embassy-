    ...
    const servicesData = [
        {
            ...
            img: visa,
            description:
                "Collect your online visa established fact that by the readable content of a lot layout. The point of using Lorem a more-or-less normal distribu to using Content here",
        },
        {
            _id: 2,
    ...
    return (
        <div className='my-5 md:my-20 mx-2 md:mx-5'>
            <div className='text-center my-7'>
                ...
                <h3 className='text-3xl text-neutral'>The online embassy service we provide</h3>
            </div>
